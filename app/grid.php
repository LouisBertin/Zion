        ...
        <div class="col-2_sm-12">
            <nav class="side vertical">
                <ul>
                    ...
                    <li><a href="#mixins">Useful mixins</a></li>
                </ul>
            </nav>
        </div>
...
<div class="grid-right">
    ...
    <div class="col">
        <!-- some stuff here -->
            ...
            <section id="helpers" class="p-t-50">
                <h2>Helpers</h2>
    ...
    <div class="col">
        <div class="demo">
            <!-- some stuff here -->
                ...
                <br>
                <div class="demo m-b-10">
                    <span class="b-flat-orange">no padding class</span>
                </div>
                <div class="demo m-b-10">
                    <span class="p-50 b-flat-orange">.p-50</span>
                </div>
                <div class="demo m-b-10">
                    <span class="p-t-50 z-block b-flat-orange">.p-t-50</span>
                </div>
                <div class="demo m-b-10">
                    <span class="p-r-50 z-block b-flat-orange">.p-r-50</span>
                </div>
                <div class="demo m-b-10">
                    <span class="p-b-50 z-block b-flat-orange">.p-b-50</span>
                </div>

                <p class="p-t-50">change the <code>margin</code></p>
                <br>
                <p>1 - you can change the margin of an item with the <code>m-*</code> attributes</p>
                <p>2 - the <code>*</code> attributes have to be a value between 0 to 50 px</p>
                <p>3 - you can edit the unit of the <code>m-*</code> attributes in the <code>_z-helpers.scss</code></p>

                <div class="demo m-b-10">
                    <span class="b-flat-orange">no margin class</span>
                </div>
                <div class="demo m-b-10">
                    <span class="m-50 z-block b-flat-orange">.m-50</span>
                </div>


            </section>

            <section id="mixins" class="p-t-50">
                <h2>Useful Mixins</h2>
                <p>a list of magic mixins to improve your development</p>
                <hr>

                <h3>the <code>fontFace</code> mixin</h3>
                <p>a way to include easily your custom fonts</p>
                <br>

                <p>1 - <code>fontFace($family,$src, $only: default, $style: normal, $weight: normal)</code> </p>
                <p>2 - <code>$family</code> the family name - <code>$src</code> /path/to/your/font - <code>$only</code> if you only have one font file to load your font</p>
                <p>3 - what's going on if i want to load a MyFont.ttf ?</p>
                <br>

                <div class="grid-2">
                    <div class="col"><pre class="noPadding"><code class="language-markup"><script type="prism-html-markup">
<style>
    @include fontFace('SF-thin','../fonts/SF/SF-thin', ttf);
</style>
</script></code></pre>
                    </div>
                    <div class="col"><pre class="noPadding"><code class="language-markup"><script type="prism-html-markup"><style>
@font-face {
  font-family: "SF-regular";
  src: url("../fonts/SF/SF-regular.ttf") format("truetype");
  font-style: normal;
  font-weight: normal; }
</style>
</script></code></pre>
                ...
                <p>4 - and if you let the <code>$only</code> by default</p>
                <br>
                <div class="grid-2">
                    <div class="col"><pre class="noPadding"><code class="language-markup"><script type="prism-html-markup">
<style>
...
@font-face {
  font-family: "SF-thin";
  src: url("../fonts/SF/SF-thin.eot");
  src: url("../fonts/SF/SF-thin.eot?#iefix") format("embedded-opentype"),
  url("../fonts/SF/SF-thin.woff") format("woff"),
  url("../fonts/SF/SF-thin.ttf") format("truetype"),
  url("../fonts/SF/SF-thin.svg#SF-thin") format("svg");
  font-style: normal;
  font-weight: normal; }
</style>
</script></code></pre>
                ...
                <br><br><br>
                <h3>the <code>makeColors</code> and <code>makeBackColors</code> mixins</h3>
                <p>a way to include easily your custom font and background colors</p>
                <br>

                <p>1 - the <code>makeColors</code> mixins</p>
                <p>this mixin is used in order to add the main font colors of your project</p>
                <br>
                <div class="grid-2">
                    <div class="col">
                        <code>Scss</code>
                        <pre class="noPadding"><code class="language-markup"><script type="prism-html-markup"><style>
    @include makeColors(black,#000);
</style>
</script></code></pre>
                    </div>
                    <div class="col">
...
.black {
  color: #000;
                ...
                <p>2 - the <code>makeBackColors</code> mixins</p>
                <p>this mixin is used in order to add the main background colors of your project</p>
                <br>
                <div class="grid-2">
                    <div class="col">
                        <code>Scss</code>
                        <pre class="noPadding"><code class="language-markup"><script type="prism-html-markup"><style>
    @include makeBackColors(flat-orange,#f39c12);
</style>
</script></code></pre>
                    </div>
                    <div class="col">
